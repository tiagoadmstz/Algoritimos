 ...
 */
public class UserPasswordManager extends javax.swing.JFrame {

    /**
     * Creates new form UserPasswordManager
     */
    ...
    private void initComponents() {
        ...
        setTitle("Formulário de Troca de Senha");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserPasswordManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserPasswordManager().setVisible(true);
            }
        });
    }
